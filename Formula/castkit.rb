class Castkit < Formula
  include Language::Python::Virtualenv

  desc "Universal model quantization and format conversion CLI"
  homepage "https://github.com/schroneko/castkit"
  url "https://files.pythonhosted.org/packages/92/5b/b5d3a82329d49906044238f6f4934035e724d33931c03a41d1a01f659ace/castkit-0.1.0.tar.gz"
  sha256 "6ae07ac7b229f2d1fbc1c4b6884feb0b27d3faf94d73bd613f0060e9094e0081"
  license "MIT"
  ...
  resource "gguf" do
    url "https://files.pythonhosted.org/packages/08/08/7de1ca4b71e7bf33b547f82bb22505e221b5fa42f67d635e200e0ad22ad6/gguf-0.17.1.tar.gz"
  ...
  test do
    assert_match version.to_s, shell_output("#{bin}/castkit --version")
    assert_match "convert", shell_output("#{bin}/castkit --help")
  end
end
